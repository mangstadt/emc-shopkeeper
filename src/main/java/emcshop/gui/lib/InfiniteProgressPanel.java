...
public class InfiniteProgressPanel extends JComponent implements MouseListener {
	 ...
	 * @param shield The alpha level between 0.0 and 1.0 of the colored shield
	 * (or veil).
	 * @param fps The number of frames per second. Lower this value to decrease
	 * CPU usage.
	 */
	 ...
	 * @param fps The number of frames per second. Lower this value to decrease
	 * CPU usage.
	 * @param rampDelay The duration, in milli seconds, of the fade in and the
	 * fade out of the veil.
	 */
	...
	public void mouseClicked(MouseEvent e) {
		//empty
		//prevents mouse events from reaching the window
	}
